...
class CustomContainer extends StatefulWidget {
  const CustomContainer({  required this.color, required this.cellNr, Key ? key}): super(key: key);
  final Color color ;
  final int cellNr ;
  @override
    ...
    final GridView board = GridView.builder(
      ...
      itemBuilder: (BuildContext context, int index){
        return  GestureDetector(
          ...
          child: Container(
            color: cell[index] == 0 ? Colors.blue : cell[index] == 1 ? Colors.red : Colors.green,
            child: Text('$index'),
          ),
        );
      },
